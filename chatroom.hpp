...
class Room {
        ...
        public:
            virtual join(ParticipantPointer participant);
            virtual leave(ParticipantPointer participant);
            virtual deliver(ParticipantPointer participantPointer , Message &message);
